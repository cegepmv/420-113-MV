...
*Source : [dictionnaire Larousse](https://www.larousse.fr/dictionnaires/francais/p%C3%A9riph%C3%A9rique/59602)*

## Type de périphériques

Dépendemment de la direction du flux d'information échangé entre le périphérique et l'ordinateur, il est possible de classer les périphériques de la manière suivante : 
...
+ **Périphérique de sortie :** L'information provient de l'ordinateur vers le périphérique.
      + *Exemple :* moniteur 
+ **Périphérique d'entrée et de sortie :** L'information circule dans les deux sens :
      + Périphérique de communication : Permet l'échange d'information entre deux ordinateurs.
      + Périphérique de stockage : Permet le stockage d'information 
            + *Exemple* : disque dur, clé USB etc... 
      + Etc.
...
+ **Volatile vs. non-volatile** : Une mémoire volatile perd les information stocké lorsqu'on lui retire volontairement ou pas l'électricité. Une mémoire non-volatile ne perdra pas les information stocké à moins d'une corruption des données ou d'un malfonctionnement interne.
